...
const deleteAllTask = document.querySelector("#deleteAllDoneTask");
...
deleteAllTask.addEventListener("click", deleteAllDoneTask);
...
function deleteAllDoneTask(){
	...
	listGroupItems.forEach(function(item) {
		const doneTask = item.querySelector(".task-title--done");
